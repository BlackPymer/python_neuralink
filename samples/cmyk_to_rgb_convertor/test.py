...
def convert(*args):
    ...
    if None in [c, m, y, k]:
        ...
        rgb_box.itemconfig(rectangle_rgb, fill=rgb_to_hex(0, 0, 0))  # Default to black
        return
    ...
    try:
        ...
        print([r, g, b])
        rgb_box.itemconfig(rectangle_rgb, fill=rgb_to_hex(r, g, b))
    except Exception as e:
...
if __name__ == "__main__":
    if not Path(data_file_name).exists():
        ...
        # Create Canvas and draw default rectangles
        ...
        rgb_box = Canvas(root, width=300, height=300)
        rgb_box.place(x=600, y=300)
        ...
        convert_button.place(x=400, y=600, width=200, height=50)
